        ...
        <div className="block mt-5">
            <div className="row">
                ...
                <div className="icon"><a href="tel:+94 0703301830">{phone}</a></div>
                  ...
                  <p className="contact-text">+94 0718183378</p></div>
                <div className="col-10 mx-auto col-lg-4 text-center item sep-vertical my-2">
                <div className="icon"><a href="mailto:chandimapr@gmail.com">{address}</a></div>
                ...
                <div className="icon"><a href="mailto:chandimapr@gmail.com">{email}</a></div>
                    <h6 className="contact-type">Email</h6>
                    <p className="contact-text">chandimapr@gmail.com</p>
                </div>
              </div>
        </div>
